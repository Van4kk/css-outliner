    ...
    <page-wrapper>
        <template v-if="condition.isElementSelected">
            <div id="css-outliner-element-properties-page-tabs-nav">
                <button :class="{ 'text-white-hover' : activeTab === 'attributes' }" @click="switchTab('proprieties')">
                    Element proprieties
                </button>
                <button :class="{ 'text-white-hover' : activeTab === 'proprieties' }" @click="switchTab('attributes')">
                    Element attributes
                </button>
            ...
            <div id="css-outliner-element-properties-page-tabs">
                <div id="css-outliner-element-properties-tab"
                     :class="{ 'css-outliner-element-properties-active-tab' : activeTab === 'proprieties'}">
                    <ElementDetails :properties="condition.properties" :show-info="false" :show-colors="true" />
                </div>
                <div id="css-outliner-element-attributes-tab"
                     :class="{ 'css-outliner-element-properties-active-tab' : activeTab === 'attributes'}">
